...
Note: creating abstraction - why? pulling things into function 

create a React element with the 'type of div' to interpolate the function

Create a 'type of message' by using the react.createElement API directly - I can't see this in the component dev tools 

an element is created when we create a function with the 'type of Message' which has implications for - custom element - creation.

Solution 3/4: production only 'prop type validators' are removed from the production code. 

Typechecking With PropTypes https://reactjs.org/docs/typechecking-with-proptypes.html  and  https://www.npmjs.com/package/prop-types  

``npm install --save prop-types`` 

Q: -- development version @15.6-- or -- production version @15.6 -- but current version 15.8.1

- Run through using jsx and propTypes

<> is compiled as <React.Fragment> in the DOM and allows for the rendering of two things side by side
      <>
