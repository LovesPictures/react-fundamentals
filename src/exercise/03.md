...
Q: What does idiomatic means in the context of React? in light of the introduction of Hooks?

Q: DOM Elements: https://reactjs.org/docs/dom-elements.html#differences-in-attributes

Q; Interoperability: usability between systems https://reactjs.org/docs/design-principles.html - A mechanism to switch between javascript, jsx and Html or other programmes - the ability to mix the markup with javascript 
